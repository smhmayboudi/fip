use crate::{
    config::Config, controller::Controller, proto::rt_server::RtServer, repository::Repository,
    service::Service,
};
    ...
    pub async fn check(mut reporter: HealthReporter) {
        ...
        loop {
            ...
            if iter % 2 == 0 {
                ...
                reporter.set_not_serving::<RtServer<Controller>>().await;
            };
        }
    }
