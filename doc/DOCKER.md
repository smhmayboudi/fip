...
$ docker pull materialize/materialized:v0.9.8
# https://hub.docker.com/_/microsoft-vscode-devcontainers
$ docker pull mcr.microsoft.com/vscode/devcontainers/rust:0.201.0-1-bullseye
$ docker pull openzipkin/zipkin:2.23.2
$ docker pull registry:2.7.1
$ docker pull rust:1.56.0-bullseye
...
$ docker pull timberio/vector:0.17.0-distroless-static
$ docker pull vectorized/redpanda:v21.9.5
```
