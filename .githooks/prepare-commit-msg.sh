...
# https://gitlab.playpod.ir/alpha/project-template/-/blob/main/CONTRIBUTING.md#commit
#
...
#   │                          https://gitlab.playpod.ir/alpha/project-template/-/blob/main/CONTRIBUTING.md#scope
#   │
#   └─⫸ Commit Type: build|ci|docs|feat|fix|perf|refactor|style|test
#                     https://gitlab.playpod.ir/alpha/project-template/-/blob/main/CONTRIBUTING.md#type
#
#
# Commit Message Body
# ---------------------
#
# Just as in the summary, use the imperative, present tense: "fix" not "fixed" nor "issue".
#
